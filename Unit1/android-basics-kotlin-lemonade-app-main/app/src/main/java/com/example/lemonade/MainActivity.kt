...
class MainActivity : AppCompatActivity() {
    ...
    private var textAction: TextView = findViewById<TextView>(R.id.text_action)
    ...
    private fun clickLemonImage() {
        ...
        when (lemonadeState) {
            "select" -> {
                ...
                textAction.text = "Click on the lemon tree to get a lemon!"
                lemonadeState = SQUEEZE
            }
            "squeeze" -> {
                lemonImage!!.setBackgroundResource(R.drawable.lemon_squeeze)
                textAction.text = "Click to squeeze the lemon!"
                lemonadeState = DRINK
            }
            "drink" -> {
